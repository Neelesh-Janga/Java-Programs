<h2><a href="https://leetcode.com/problems/maximum-number-of-balloons">1189. Maximum Number of Balloons</a></h2><h3>Easy</h3><hr>

<div class="elfjS" data-track-load="description_content"><p>Given a string <code>text</code>, you want to use the characters of <code>text</code> to form as many instances of the word <strong>"balloon"</strong> as possible.</p>
